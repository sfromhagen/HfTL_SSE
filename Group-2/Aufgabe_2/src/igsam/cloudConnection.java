...
public class cloudConnection {
	...
	public String getDevice(String serial) throws Exception {
		...
		connection.setRequestProperty("Accept",
				"application/vnd.com.nsn.cumulocity.externalId+json,application/vnd.com.nsn.cumulocity.error+json; charset=UTF-8;ver=0.9");
	...
	public String sendAlarms(String tenantId, String alarmText, String timestamp, String alarmType, String alarmStatus,
			String alarmSeverity) throws Exception {
	...
	public void sendEvent(String tenantId, float altValue, float lngValue, float latValue, String timestamp, String msg,
